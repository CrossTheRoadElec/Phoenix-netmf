...
{
    public class SmartMotorController : IGadgeteerUartClient, IMotorController
    {
        public enum Faults
        {
            kCurrentFault = 1,
        ...
        private CTRE.Phoenix.LowLevel_TalonSrx m_impl;
         ...
         */
        public SmartMotorController(int deviceNumber, bool externalEnable = false)
        {
        ...
        public void SetControlMode(BasicControlMode basicMode)
        {
            SetControlMode(ControlModeRoutines.Promote(basicMode));
        }
       ...
       */
        ...
        public void EnableZeroSensorPositionOnIndex(bool enable, bool risingEdge, uint timeoutMs = 0)
        {
            if (enable)
            {
                ...
                ConfigSetParameter(CTRE.Phoenix.LowLevel_TalonSrx.ParamEnum.eQuadIdxPolarity, risingEdge ? 1 : 0, timeoutMs);
                ConfigSetParameter(CTRE.Phoenix.LowLevel_TalonSrx.ParamEnum.eClearPositionOnIdx, 1, timeoutMs);
            }
            else
            {
                /* disable the feature first, then update the edge polarity. */
                ConfigSetParameter(CTRE.Phoenix.LowLevel_TalonSrx.ParamEnum.eClearPositionOnIdx, 0, timeoutMs);
                ConfigSetParameter(CTRE.Phoenix.LowLevel_TalonSrx.ParamEnum.eQuadIdxPolarity, risingEdge ? 1 : 0, timeoutMs);
            }
        }
		/**
         ...
         */
		 ...
		 {
			 ConfigSetParameter(CTRE.Phoenix.LowLevel_TalonSrx.ParamEnum.eClearPositionOnLimitF, enable ? 1 : 0, timeoutMs);
		 }
		 /**
         * Enables Talon SRX to automatically zero the Sensor Position whenever an
         ...
         */
		 ...
		 {
			 ConfigSetParameter(CTRE.Phoenix.LowLevel_TalonSrx.ParamEnum.eClearPositionOnLimitR, enable ? 1 : 0, timeoutMs);
        }
        /**
        ...
        */
         ...
         */
        public CTRE.Phoenix.LowLevel_TalonSrx GetLowLevelObject() { return m_impl; }
        ...
        {
            TalonSrx master = (TalonSrx)masterToFollow;
            /* set it up */
            SetControlMode(ControlMode.kFollower);
