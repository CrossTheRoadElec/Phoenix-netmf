...
namespace CTRE.Phoenix
{
    ...
    public class CANifier
    {
         ...
         * @param pulseWidthAndPeriod	Double array to hold Pulse Width (microseconds) [0] 
         *                              and Period (microseconds) [1].
	 ...
	 */
         ...
         * @return Error Code generated by function. 0 indicates no error.
         */
        public ErrorCode ConfigVelocityMeasurementPeriod(CANifierVelocityMeasPeriod period, int timeoutMs = 0)
        {
        ...
        {
            ErrorCode retval = _ll.ConfigClearPositionOnLimitR(clearPositionOnLimitR, timeoutMs);
            return retval;
        }
        /**
   ...
   *            If zero, no blocking or checking is performed.
	 ...
	 */
       ...
       *            If zero, no blocking or checking is performed.
         ...
         */
        public double ConfigGetParameter(ParamEnum param, int ordinal, int timeoutMs = 0)
        {
            int retval;
   ...
   *            If zero, no blocking or checking is performed.
	 * @return Error Code generated by function. 0 indicates no error.
	 */
        public ErrorCode SetStatusFramePeriod(CANifierStatusFrame statusFrame, int periodMs, int timeoutMs = 0)
        {
       ...
       *            If zero, no blocking or checking is performed.
         ...
         */
        public int GetStatusFramePeriod(CANifierStatusFrame frame, int timeoutMs = 0)
        {
            int period;
