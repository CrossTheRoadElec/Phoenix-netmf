...
namespace CTRE.Phoenix
{
     ...
     */
    public class PowerDistributionPanel : Device_LowLevel
    {
        UInt64 _cache;
        UInt32 _len;
        ...
        /** CAN frame defines */
        const UInt32 STATUS_1 = 0x08041400; //Channels 0-5
        const UInt32 STATUS_2 = 0x08041440; //Channels 6-11
        const UInt32 STATUS_3 = 0x08041480; //Channels 12-15

        /**
         * Create a PDP object that communicates on CAN Bus.
         * @param deviceNumber [0,62] Device ID of PDP.
         */
        public PowerDistributionPanel(uint deviceId)
              : base(deviceId, 0x00, 0, 0, 0, 0)// todo
        {
        }
        ...
        {
            float retval = 0;
            int errCode = (int)ErrorCode.CAN_INVALID_PARAM;
