...
//{
//    public class ParamContainer : Device_LowLevel
//    {
...
//        ErrorCodeVar _lastErr = new ErrorCodeVar();

//        private System.Collections.Hashtable _sigs = new System.Collections.Hashtable();

//        public ParamContainer(UInt32 deviceId, UInt32 paramReqId, UInt32 paramRespId, UInt32 paramSetId) : base(deviceId, 0)
//        {
...
//        public Int32 GetParam(byte paramEnum, uint timeoutMs = 4)
//        {
//            Int32 value = 0;
...
//            {
//                /* wait a bit */
//                System.Threading.Thread.Sleep(1); /* small yield for getting response */

//                /* see if response was received */
//                int statu2 = GetParamResponseRaw(paramEnum, out value);
//                if (statu2 == 0) /* if we got it, leave */
//                {
//                    _lastErr.SetLastError(ErrorCode.OK);
//                    break;
//                }
...
//            _lastErr.SetLastError(ErrorCode.CAN_MSG_NOT_FOUND);
